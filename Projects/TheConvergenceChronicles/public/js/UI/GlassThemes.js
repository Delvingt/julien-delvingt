  ...
  function applyThemeStyles() {
    ...
    styleEl.textContent = `
      ...
      :root {
        ...
        --glass-star: ${palette.star};
        --glass-star-empty: ${palette.starEmpty};
        --glass-gradient: linear-gradient(135deg, var(--glass-primary), var(--glass-secondary));
        --glass-gradient-full: linear-gradient(135deg, var(--glass-primary), var(--glass-secondary), var(--glass-accent));
      }
